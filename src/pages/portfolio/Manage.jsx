...
function Manage() {
    ...
    <div className="sites_nav">
            ...
            <Link to="/fylo" className='nav_link'><img className='arrow' src={leftArrow} alt="left-arrow-icon" /></Link> 
            <h2 className="secondary_title">Fylo</h2>
            <p className="grey">Previous Project</p>
        </div>
        <div className="center_line"></div>
        <div className="swipe_right">
            <Link to='/bookmark' className='nav_link'><img className='arrow' src={rightArrow} alt="right-arrow-icon" /></Link> 
